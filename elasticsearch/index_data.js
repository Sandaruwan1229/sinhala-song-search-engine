...
async function run() {
  ...
  const body = dataset.flatMap(doc => [{ index: { _index: 'sinhala_songs_metaphor' } }, doc])
  ...
  const { body: count } = await client.count({ index: 'sinhala_songs_metaphor' })
  console.log(count)
}
